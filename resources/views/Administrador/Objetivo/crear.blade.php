...
@section('menu-sup-02')
    ...
    <li class="breadcrumb-item"><a href="{{route('grados')}}">Objetivos Socioeconómicos</a></li>
        ...
        <div class="col-sm-5">
            <div class="card">
                <div class="card-header">
                    <strong>Objetivos Socioeconómicos :: Agregar</strong>
                </div>
                <div class="card-body">
                    <form action="{{ route('objetivo.crear.post') }}" method="post" id="frm_crear" name="frm_crear">
                        {{ csrf_field()  }}
