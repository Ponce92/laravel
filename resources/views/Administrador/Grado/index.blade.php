...
@section('menu-sup-02')
    ...
    <li class="breadcrumb-item active">Grados academicos</li>
@endsection
...
@section('default')
    <div class="container-fluid area-trabajo" id="area-trabajo">
        ...
        <div class="row cabeza-seccion">
            <div class="col-8">
                <h2 class="titulo-seccion titulo">Grados academicos</h2>
            </div>
            <div class="col-4">
                <div class="row justify-content-end" style="padding-right: 25px;">
                    <a href="{{ route('grado.crear') }}">
                                    ...
                                    @foreach ($list as $obj)
                                        <tr>
                                            ...
                                            <td align="center" class="align-middle">
                                                <a href="{{ route('grado.editar',[$id=$obj->getId()]) }}">
